...
public:
    ...
    ImVec4 getPlotLinePropertiesColour(const std::string& series_label) const;
    double getPlotLinePropertiesThickness(const std::string& series_label) const;
    ImPlotMarker getPlotLinePropertiesMarkerStyle(const std::string& series_label) const;
    double getPlotLinePropertiesMarkerSize(const std::string& series_label) const;
    ImVec4 getPlotLinePropertiesFill(const std::string& series_label) const;
    double getPlotLinePropertiesFillWeight(const std::string& series_label) const;
    ImVec4 getPlotLinePropertiesFillOutline(const std::string& series_label) const;
